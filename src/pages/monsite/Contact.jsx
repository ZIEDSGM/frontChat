...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_4ibivbr', 'template_05p8dx8', form.current , '3FSkGMH_VWE5PwKVb')
      .then((result) => {
  ...
  return (
        ...
        <div className='container'>
          <div className="mx-auto bg-secondary bg-opacity-25" style={{ maxWidth: 950, maxHeight: 1000,borderRadius:"5%" }}>
            <MDBRow className="p-5 mx-3">
              <MDBCol md="4">
                <div className="text-center" style={{ marginTop: '50px'}}>
                  <MDBIcon fas icon="fa-sharp fa-regular fa-id-card text-white" size="3x" />
                  <MDBTypography tag="h3" className="text-white">Get In Touch</MDBTypography>
                  <p><i class="fa-brands fa-google"></i>WWW.TALKSQUAD.com</p>
                  <p><i className='fas fa-mail-bulk'></i>TALKSQUAD@gmail.com</p>
                  ...
                  <MDBCardBody className="mt-0 mx-2">
                    ...
                    <form  ref={form} className="mb-0 px-10" onSubmit={sendEmail}>
                      <MDBRow className="mb-4">
                        <MDBCol>
                          <MDBInput label='firstname' type='text' name='firstname' />
                        </MDBCol>
                        <MDBCol>
                      ...
                      <MDBRow className="mb-4">
                        ...
                        <MDBCol>
                          <MDBInput label='shortMessage' type='text' name='shortMessage' />
                        </MDBCol>
                      </MDBRow>
                      <MDBRow className="mb-4">
                        <MDBCol>
